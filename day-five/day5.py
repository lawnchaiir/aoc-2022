...
class Solver(ABC):
    ...
    def solve(self):
        for move in self.move_instructions:
            ...
            self.consume_move_instructions(move_count, source_stack, target_stack)
...
Solver.move_instructions = input[key_index + 2:] # skip the key and blank line after

part1_solver = Part1Solver(stacks)
part1_solver.solve()

part2_solver = Part2Solver(stacks)
part2_solver.solve()